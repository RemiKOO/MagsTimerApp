...
class homepage:
    def create(self):
        ...
        # Setting specific variables to specific images as labels through
        ...
        # Placing these specific Images in their respective positions
        ...
        # Creating Labels of All Texts on the HomePage
        self.Title = ttk.Label(self, text="STimer", font=("LostWages", 60))
        self.SUBTitle = ttk.Label(self,
                                  text="   Modernised Study Time Management  ",
                                  font=('Courier New', 13, 'underline'))
        self.Input1req = ttk.Label(self, text="Enter Name",
                                   font=("Mangabey", 20))
        self.Input2req = ttk.Label(self, text="Study Duration (Minutes)",
                                   font=("Mangabey", 20))
        self.Input3req = ttk.Label(self, text="Break Duration (Minutes)",
                                   font=("Mangabey", 20))
        ...
        self.buttonBegin = tk.Button(self, text="Start", font=("Clip", 35),
                                     command=lambda: self.submit())
        # Calling ChangePage 3 Function, therefore will open index 3 of the
        # pages in the changePage list
        self.buttonInfo = tk.Button(self, text="Information",
                                    font=("Clip", 22),
                                    command=lambda: self.change_page(3))
        self.Exit = tk.Button(self, text="Exit App", font=("Clip", 22),
                              command=lambda: self.exit_app())
        # Placing these Buttons
        ...
        self.studyminuteinput = ttk.Entry(self, width=8,
                                          font=("Cambria bold", 12))
        self.breakminuteinput = ttk.Entry(self, width=8,
                                          font=("Cambria bold", 12))
        # Placing Inputs
