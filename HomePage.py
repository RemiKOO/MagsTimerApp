...
class homepage:
    def create(self):
        ...
        top_left_lbl = Label(self, image=self.imgList[0])
        top_left_lbl.place(x=25, y=10)
        mid_left_lbl = Label(self, image=self.imgList[1])
        mid_left_lbl.place(x=5, y=160)
        botm_left_lbl = Label(self, image=self.imgList[2])
        botm_left_lbl.place(x=25, y=310)
        top_right_lbl = Label(self, image=self.imgList[3])
        top_right_lbl.place(x=560, y=0)
        botm_right_lbl = Label(self, image=self.imgList[4])
        botm_right_lbl.place(x=600, y=325)
        mid_right_lbl = Label(self, image=self.imgList[5])
        mid_right_lbl.place(x=565, y=185)
